...
export const Route = createFileRoute('/_dashboard/_content/competitions/$compId/_settings')(
  {
    component: CompetitionSettingsLayout,
  },
)

function CompetitionSettingsLayout() {
